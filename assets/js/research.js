...
const research = [
    {
        title: "Reproduce the model of out-of distribution data augmented training (OAT) proposed in the paper Removing Undesirable Feature Contributions Using Out-ofdistribution Data by Saehyung et al.",
        authors: "Yutian Fu, Junjian Chen, Sichang Zhang",
        conferences: "",
        researchYr: 2021,
        citebox: "popup1",
        image: "assets/images/research-page/r.png",
        citation: {
            vancouver: ""
        },
        abstract: "In this project, we reproduce the model of out-of distribution data augmented training (OAT) proposed in the paper Removing Undesirable Feature Contributions Using Out-ofdistribution Data by Saehyung et al.The main specialty of the model is using out-of distribution (OOD) data during training to limit the contribution of non-robust features hence improving the robustness of the model. We reproduce the accuracy comparisons of different models on clean or perturbed CARFI-10 and ImgNet10 and further investigate the robust generalization under the proposed method with pseudo-labeled data.",
        absbox: "absPopup1"
    },
